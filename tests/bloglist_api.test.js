...
describe("blog route is protected", () => {
  ...
  describe("adding a blog", () => {
    ...
    test("fails with proper status code if user is not authenticated", async () => {
      const newBlog = {
        title: "First class tests",
        author: "Pascal Milton",
        url: "http://blog.cleancoder.com/uncle-bob/2017/05/05/TestDefinitions.htmll",
  ...
  describe("updating a blog", () => {
    test("succeeds with status code 200 if user is authenticated and data and 'id' are valid", async () => {
